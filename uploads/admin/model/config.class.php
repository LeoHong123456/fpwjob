...
class config_controller extends adminCommon{
	...
	function save_logo_action(){
	    ...
	    $this->logo_reset("sy_px_logo",$_POST['sy_px_logo']);
		...
		$this->logo_reset("sy_zph_icon",$_POST['sy_zph_icon']);
		$this->logo_reset("sy_zphbanner_icon",$_POST['sy_zphbanner_icon']);
	    $this->logo_reset("sy_cplogo",$_POST['sy_cplogo']);
		$this->web_config();
