...
class admin_keyword_controller extends adminCommon{
	...
	function set_search(){
		$keywordarr=array("1"=>"店铺招聘","2"=>"兼职","3"=>"职位","4"=>"公司","5"=>"简历","6"=>"猎头","7"=>"猎头职位","8"=>"微信搜索","9"=>"培训课程","10"=>"培训机构","11"=>"培训师",'12'=>'问答','13'=>'普工简历');
	...
	function ajax_action(){
		$keywordarr=array("1"=>"店铺招聘","2"=>"兼职","3"=>"职位","4"=>"公司","5"=>"简历","6"=>"猎头","7"=>"猎头职位","8"=>"微信搜索","9"=>"培训课程","10"=>"培训机构","11"=>"培训师","13"=>"普工简历");
