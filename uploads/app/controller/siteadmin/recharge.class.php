 ...
 */
class recharge_controller extends siteadmin_controller{
	function index_action(){
		...
		if(isset($_POST['insert'])){
			...
			$nid?$this->ACT_layer_msg("会员(ID:".@implode(',',$uids).")".$fsmsg.$msg."成功！",9,$_SERVER['HTTP_REFERER'],2,1):$this->ACT_layer_msg("不存在该会员,无法".$fsmsg,8,$_SERVER['HTTP_REFERER']);
		}
		$this->yuntpl(array('siteadmin/admin_recharge'));
	}
