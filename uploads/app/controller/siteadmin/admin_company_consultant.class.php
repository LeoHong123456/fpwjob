 ...
 */
class admin_company_consultant_controller extends siteadmin_controller{
	...
	function index_action(){
		...
		$_GET['c'] = 'index';
		$this->siteadmin_tpl(array('admin_consultant_list'));
	}
	function del_action(){
		$this->check_token();
		if ($_GET['del']){
	...
	function show_action(){
		...
		$this->siteadmin_tpl(array('admin_company_consultant_show'));
	}
    ...
    $this->yunset('rows',$rows);
    $this->siteadmin_tpl(array('admin_consultant_comlist'));
	}
