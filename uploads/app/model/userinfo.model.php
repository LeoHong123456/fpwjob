...
class userinfo_model extends model{
    function GetUserinfoOne($Where=array(),$Options=array('usertype'=>null,'field'=>null)){
        ...
        $TableName='company';
        $TableNameList=array(1=>'resume',2=>'company',3=>'lt_info',4=>'px_train');
	...
	function UpdateUserStatis($Values=array(),$Where=array(),$Options=array('usertype'=>null)){
		...
		$tables=array(1=>'member_statis',2=>'company_statis',3=>'lt_statis',4=>'px_train_statis');
				...
				if($res){
					if($userinfo['status']=='1'){
						...
						if($bindinfo['qqid']){
							...
							$sqlBind = "`qqid`='".$bindinfo['qqid']."',`qqunionid`='".$bindinfo['qqunionid']."'";
						}
