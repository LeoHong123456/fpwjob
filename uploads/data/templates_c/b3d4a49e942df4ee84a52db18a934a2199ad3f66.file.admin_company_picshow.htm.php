<?php /* Smarty version Smarty-3.1.21-dev, created on 2020-02-16 16:38:54
         compiled from "/www/fpwjob/uploads/app/template/admin/admin_company_picshow.htm" */ ?>
<?php /*%%SmartyHeaderCode:21165389915e48ff9e229fd7-44775467%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b3d4a49e942df4ee84a52db18a934a2199ad3f66' => 
    array (
      0 => '/www/fpwjob/uploads/app/template/admin/admin_company_picshow.htm',
      1 => 1572067312,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '21165389915e48ff9e229fd7-44775467',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5e48ff9e2b7c12_75132993',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5e48ff9e2b7c12_75132993')) {function content_5e48ff9e2b7c12_75132993($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<html>
<head>
...
">企业LOGO</a></li> 
				<li class="curr"><a href="index.php?m=admin_company_pic&c=show&comid=<?php echo $_GET['comid'];?>
">企业环境</a></li> 
...
">企业横幅</a></li>  
		...
		<div class="admin_new_tip">
			...
			<div class="admin_new_tip_list_cont">
				<div class="admin_new_tip_list">该页面展示了网站全部企业环境图片管理</div>
				<div class="admin_new_tip_list">您可以对企业上传的环境图片进行修改删除操作</div>
			</div>
		</div>
			...
			<div class="admin_new_search_box">
				...
				<form action="index.php" name="myform" method="get" >
					...
					<div class="admin_Filter_text formselect" did="dcom_type"> 
						<input type="button" <?php if ($_GET['type']=='1'||$_GET['type']=='') {?> value="企业全称" <?php } elseif ($_GET['type']=='2') {?> value="用户ID" <?php } elseif ($_GET['type']=='3') {?> value="环境名称" <?php }?> class="admin_new_select_text" id="bcom_type">
...
echo $_GET['type'];
						...
						<div class="admin_Filter_text_box" style="display:none" id="dcom_type">
							...
							<ul>
								...
								<li><a href="javascript:void(0)" onClick="formselect('3','com_type','环境名称')">环境名称</a></li>
							</ul>  
						</div>
					</div>
						...
						<div class="admin_zph_img">
							<div class="admin_zph_img_box">
								<div class="admin_zph_img_box_img">
									...
									<?php if ($_smarty_tpl->tpl_vars['list']->value['picurl']) {?>
										<img  onclick="show_pic('<?php echo $_smarty_tpl->tpl_vars['list']->value['picurl'];?>
','<?php echo $_smarty_tpl->tpl_vars['list']->value['id'];?>
','<?php echo $_smarty_tpl->tpl_vars['list']->value['name'];?>
')" src="<?php echo $_smarty_tpl->tpl_vars['list']->value['picurl'];?>
...
"   name='del[]' onclick='unselectall()' rel="del_chk" class="admin_com_img_checkbox check_all">
								...
								<div class="admin_comimg_box_img_p_b"><div class="admin_comimg_box_img_p"><?php echo $_smarty_tpl->tpl_vars['list']->value['title'];?>
</div></div>
...
','<?php echo $_smarty_tpl->tpl_vars['list']->value['sort'];?>
')" class="admin_new_c_bth">修改</a>
									
									<a href="javascript:void(0)" onClick="layer_del('确定要删除？', 'index.php?m=admin_company_pic&c=del&type=show&delid=<?php echo $_smarty_tpl->tpl_vars['list']->value['id'];?>
...
';
		...
		function addImg(id,comname,comtitle,comsort){
			$("#comname").val(comname);
			$("input[name=id]").val(id);
			$("input[name=title]").val(comtitle);
			$("input[name=sort]").val(comsort);
			$.layer({
				type : 1,
				title :'修改企业环境图片',
				closeBtn : [0 , true],
