<?php /* Smarty version Smarty-3.1.21-dev, created on 2020-02-16 16:16:36
         compiled from "/www/fpwjob/uploads/app/template/admin/admin_ltclass.htm" */ ?>
<?php /*%%SmartyHeaderCode:12734453155e48fa64e7e749-24271883%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c6e89bc7775c3b69fa4fe47235040aa61d21e7d6' => 
    array (
      0 => '/www/fpwjob/uploads/app/template/admin/admin_ltclass.htm',
      1 => 1572067312,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '12734453155e48fa64e7e749-24271883',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5e48fa64ef5d78_97408427',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5e48fa64ef5d78_97408427')) {function content_5e48fa64ef5d78_97408427($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<html>
<head>
...
<div class="admin_new_tip">
    ...
    <div class="admin_new_tip_list_cont">
      <div class="admin_new_tip_list">该页面展示了网站猎头会员分类信息，可对猎头会员分类编辑修改操作。</div>
    </div>
  </div>
  <div class="admin_new_search_box">
  <a  href="javascript:void(0)" onClick="add_class('猎头会员分类','450','370','#wname','index.php?m=ltclass&c=save')"class="admin_new_cz_tj" style="margin-left:0px;">+ 添加类别</a>
  </div>
  <div class="clear"></div>
...
<form action="index.php?m=ltclass&c=del" id='myform' method="post" target="supportiframe">
<table width="100%">
	<thead>
...
" size="20" disabled/></td>
		<td class="ud">
        <A href="index.php?m=ltclass&c=up&id=<?php echo $_smarty_tpl->tpl_vars['v']->value['id'];?>
" class="admin_new_c_bth">管理</A>
        <A href="javascript:void(0)" onClick="layer_del('确定要删除？', 'index.php?m=ltclass&c=del&delid=<?php echo $_smarty_tpl->tpl_vars['v']->value['id'];?>
...
');"/>
        ...
        <td class="ud"></td>
		<td class="ud" width="180"><A href="javascript:void(0)" onClick="layer_del('确定要删除？', 'index.php?m=ltclass&c=del&delid=<?php echo $_smarty_tpl->tpl_vars['class1']->value['id'];?>
');"class="admin_new_c_bth admin_new_c_bth_sc">删除</A></td>
	</tr>
	<?php  $_smarty_tpl->tpl_vars['v'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['v']->_loop = false;
...
');"/>
		...
		<td class="ud"><A href="javascript:void(0)" onClick="layer_del('确定要删除？', 'index.php?m=ltclass&c=del&delid=<?php echo $_smarty_tpl->tpl_vars['v']->value['id'];?>
');"class="admin_new_c_bth admin_new_c_bth_sc">删除</A></td>
	</tr>
	<?php } ?>
	<?php }?>
