<?php /* Smarty version Smarty-3.1.21-dev, created on 2019-11-08 16:14:46
         compiled from "/www/fpwjob/uploads/app/template/member/lietou/member_time.htm" */ ?>
<?php /*%%SmartyHeaderCode:19306070835dc523f6b440c5-28234067%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4896aa13aa789d3c688ce16b4153b94a5064839a' => 
    array (
      0 => '/www/fpwjob/uploads/app/template/member/lietou/member_time.htm',
      1 => 1572067313,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '19306070835dc523f6b440c5-28234067',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5dc523f6bbe139_78897663',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5dc523f6bbe139_78897663')) {function content_5dc523f6bbe139_78897663($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/www/fpwjob/uploads/app/include/libs/plugins/modifier.date_format.php';
...
天<?php } else { ?>永久<?php }?>
								...
								<div class="com_grade_listp">
									服务内容：<?php if ($_smarty_tpl->tpl_vars['list']->value['explains']) {
echo $_smarty_tpl->tpl_vars['list']->value['explains'];
} else {
...
');" class="added_list_gm">立即购买</a>
								...
								<div class="yhtime_box">   
									...
									<?php if ($_smarty_tpl->tpl_vars['list']->value['time_start']<time()&&$_smarty_tpl->tpl_vars['list']->value['time_end']>time()&&$_smarty_tpl->tpl_vars['list']->value['coupon']) {?>
										赠送：<font color="#f00"><?php echo $_smarty_tpl->tpl_vars['list']->value['coupon'];?>
</font>
									<?php }?>
									</span>
								</div>
