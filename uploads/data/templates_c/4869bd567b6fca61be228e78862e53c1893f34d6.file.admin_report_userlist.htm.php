<?php /* Smarty version Smarty-3.1.21-dev, created on 2019-11-02 16:25:24
         compiled from "/www/fpwjob/uploads/app/template/admin/admin_report_userlist.htm" */ ?>
<?php /*%%SmartyHeaderCode:16628539585dbd3d7400a340-07218615%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4869bd567b6fca61be228e78862e53c1893f34d6' => 
    array (
      0 => '/www/fpwjob/uploads/app/template/admin/admin_report_userlist.htm',
      1 => 1572067312,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '16628539585dbd3d7400a340-07218615',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5dbd3d74253fb0_78005813',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5dbd3d74253fb0_78005813')) {function content_5dbd3d74253fb0_78005813($_smarty_tpl) {?><?php if (!is_callable('smarty_function_searchurl')) include '/www/fpwjob/uploads/app/include/libs/plugins/function.searchurl.php';
...
>
 ...
 type="text/javascript">
		...
		function showrea(title,msg,type){
			var pytoken=$("#pytoken").val();
			$.post("index.php?m=report&c=showxjh",{id:msg,type:type,pytoken:pytoken},function(data){
				data=eval('('+data+')');
				$('#showboxmsg').html(data.r_reason);
				$.layer({
					type : 1,
	...
	<div class="infoboxp">
		...
		<div class="tabs_info">
			<ul>
				...
				<li<?php if ($_smarty_tpl->tpl_vars['type']->value=='3') {?> class="curr"<?php }?>><a href="index.php?m=report&type=3" >被投诉宣讲会</a> </li>
			</ul>
		</div>
	 
		<?php if ($_smarty_tpl->tpl_vars['type']->value!='1'&&$_smarty_tpl->tpl_vars['type']->value!='2'&&$_smarty_tpl->tpl_vars['type']->value!='3') {?>
							...
							<tr class="admin_table_top">
								...
								<?php if ($_smarty_tpl->tpl_vars['ut']->value==2) {?>
									<?php if ($_GET['t']=="p_uid"&&$_GET['order']=="asc") {?>
										<th style="width:90px;"><a href="<?php echo smarty_function_searchurl(array('order'=>'desc','ut'=>$_smarty_tpl->tpl_vars['ut']->value,'t'=>'p_uid','m'=>'report','untype'=>'order,t,ut'),$_smarty_tpl);?>
">用户ID<img src="images/sanj.jpg"/></a></th>
									<?php } else { ?>
										<th style="width:90px;"><a href="<?php echo smarty_function_searchurl(array('order'=>'asc','ut'=>$_smarty_tpl->tpl_vars['ut']->value,'t'=>'p_uid','m'=>'report','untype'=>'order,t,ut'),$_smarty_tpl);?>
">用户ID<img src="images/sanj2.jpg"/></a></th>
									<?php }?>
								<?php } else { ?>
									<?php if ($_GET['t']=="c_uid"&&$_GET['order']=="asc") {?>
										<th style="width:90px;"><a href="<?php echo smarty_function_searchurl(array('order'=>'desc','ut'=>$_smarty_tpl->tpl_vars['ut']->value,'t'=>'c_uid','m'=>'report','untype'=>'order,t,ut'),$_smarty_tpl);?>
">用户ID<img src="images/sanj.jpg"/></a></th>
									<?php } else { ?>
										<th style="width:90px;"><a href="<?php echo smarty_function_searchurl(array('order'=>'asc','ut'=>$_smarty_tpl->tpl_vars['ut']->value,'t'=>'c_uid','m'=>'report','untype'=>'order,t,ut'),$_smarty_tpl);?>
">用户ID<img src="images/sanj2.jpg"/></a></th>
									<?php }?>
								<?php }?>

								<th align="left" style="width:180px;"><?php if ($_smarty_tpl->tpl_vars['ut']->value==2) {?>姓名<?php } else { ?>公司名<?php }?></th>
								...
								<th align="left" style="width:200px;">邮箱</th>

								<th align="left" style="width:150px;">举报人</th>

								<?php if ($_GET['t']=="inputtime"&&$_GET['order']=="asc") {?>
									<th style="width:130px;"><a href="<?php echo smarty_function_searchurl(array('order'=>'desc','ut'=>$_smarty_tpl->tpl_vars['ut']->value,'t'=>'inputtime','m'=>'report','untype'=>'order,t,ut'),$_smarty_tpl);?>
">举报时间<img src="images/sanj.jpg"/></a></th>
								<?php } else { ?>
									<th style="width:130px;"><a href="<?php echo smarty_function_searchurl(array('order'=>'asc','ut'=>$_smarty_tpl->tpl_vars['ut']->value,'t'=>'inputtime','m'=>'report','untype'=>'order,t,ut'),$_smarty_tpl);?>
">举报时间<img src="images/sanj2.jpg"/></a></th>
								<?php }?>
								<th align="left" style="width:150px;">举报理由</th>
								<th align="left" style="width:150px;">处理结果</th>
								<th class="admin_table_th_bg" style="width:280px;">操作</th>
							</tr>
						</thead>
...
"  name='del[]' onclick='unselectall()' rel="del_chk" /></td>
									...
									<td class="ud" align="left">
										<?php if ($_smarty_tpl->tpl_vars['user']->value['usertype']=="2") {?>
											<a href="<?php echo smarty_function_url(array('m'=>'resume','c'=>'show','id'=>'`$user.eid`'),$_smarty_tpl);?>
" target="_blank" class="admin_cz_sc"><?php echo $_smarty_tpl->tpl_vars['user']->value['r_name'];?>
</a>
										<?php } else { ?>
											<a href="<?php echo smarty_function_url(array('m'=>'company','c'=>'show','id'=>'`$user.c_uid`'),$_smarty_tpl);?>
" target="_blank" class="admin_cz_sc"><?php echo $_smarty_tpl->tpl_vars['user']->value['r_name'];?>
</a>
										<?php }?>
									</td>
...
<br>
												<?php if ($_smarty_tpl->tpl_vars['email_promiss']->value=='1') {?>
													<span onClick="send_email('<?php echo $_smarty_tpl->tpl_vars['user']->value['email'];?>
');" style="color:green; cursor:pointer;">发邮件</span>
												<?php }?>
											</div>
										<?php }?>
									</td>
									...
									<td class="gd"><div style="text-align:left"><?php echo $_smarty_tpl->tpl_vars['user']->value['r_reason'];?>
</div></td>
									<td class="gd"><div style="text-align:left"><?php echo $_smarty_tpl->tpl_vars['user']->value['result'];?>
</div></td>
						
									<td> 
										<?php if ($_smarty_tpl->tpl_vars['ut']->value==2) {?> 
											<a href="javascript:void(0)" onClick="layer_del('确定要删除简历并删除该信息？', 'index.php?m=report&c=delresume&id=<?php echo $_smarty_tpl->tpl_vars['user']->value['id'];?>
&eid=<?php echo $_smarty_tpl->tpl_vars['user']->value['eid'];?>
&uid=<?php echo $_smarty_tpl->tpl_vars['user']->value['c_uid'];?>
');"class="admin_cz_sc">删除简历</a> 
										<?php } else { ?> 
											<a href="javascript:void(0)" onClick="layer_del('确定要删除职位并删除该信息？', 'index.php?m=report&c=deljob&id=<?php echo $_smarty_tpl->tpl_vars['user']->value['id'];?>
&eid=<?php echo $_smarty_tpl->tpl_vars['user']->value['eid'];?>
...
">
										...
										<?php } elseif ($_smarty_tpl->tpl_vars['r']->value['status']=="1") {?>
											<a href="javascript:void(0);" onClick="rec_up('index.php?m=report&c=recommend','<?php echo $_smarty_tpl->tpl_vars['r']->value['id'];?>
','0','status');"><img src="../config/ajax_img/doneico.gif"></a>
										<?php } else { ?>
											<a href="javascript:void(0);" onClick="rec_up('index.php?m=report&c=recommend','<?php echo $_smarty_tpl->tpl_vars['r']->value['id'];?>
','1','status');"><img src="../config/ajax_img/errorico.gif"></a>
										<?php }?>
									</td>

									<td align="left"><?php echo $_smarty_tpl->tpl_vars['r']->value['reason'];?>
</td>
									<td align="left"><?php echo $_smarty_tpl->tpl_vars['r']->value['result'];?>
</td>
...
&back_url=1" class="admin_cz_sc"> 修改问答</a> |
										<?php }?> 
...
">
		...
		<div class="admin_new_tip">
			...
			<div class="admin_new_tit"><i class="admin_new_tit_icon"></i>操作提示</div>
			<div class="admin_new_tip_list_cont">
				<div class="admin_new_tip_list">该页面展示了被投诉的宣讲会。</div>
			</div>
		</div>
					...
					<form action="index.php" name="myform" method="get" id='myform'  target="supportiframe" >
						...
						<table width="100%">
							<thead>
								<tr class="admin_table_top">
									<th><label for="chkall"><input type="checkbox" id='chkAll'  onclick='CheckAll(this.form)'/></label></th>
									<th align="left"> <?php if ($_GET['t']=="id"&&$_GET['order']=="asc") {?> <a href="<?php echo smarty_function_searchurl(array('type'=>3,'order'=>'desc','t'=>'id','m'=>'report','untype'=>'order,t,type'),$_smarty_tpl);?>
">编号<img src="images/sanj.jpg"/></a> <?php } else { ?> <a href="<?php echo smarty_function_searchurl(array('type'=>3,'order'=>'asc','t'=>'id','m'=>'report','untype'=>'order,t,type'),$_smarty_tpl);?>
">编号<img src="images/sanj2.jpg"/></a> <?php }?> </th>
									<th align="left">被投诉者</th>
									<th align="left">投诉者</th>
									<th align="left">错误宣讲会信息</th>
									<th align="left">正确宣讲会信息</th>
									<th><?php if ($_GET['t']=="inputtime"&&$_GET['order']=="asc") {?> <a href="<?php echo smarty_function_searchurl(array('type'=>3,'order'=>'desc','t'=>'inputtime','m'=>'report','untype'=>'order,t,type'),$_smarty_tpl);?>
">投诉时间<img src="images/sanj.jpg"/></a> <?php } else { ?> <a href="<?php echo smarty_function_searchurl(array('type'=>3,'order'=>'asc','t'=>'inputtime','m'=>'report','untype'=>'order,t,type'),$_smarty_tpl);?>
...
"  name='del[]' onclick='unselectall()' rel="del_chk" /></td>
										...
										<td align="left">
											<?php echo mb_substr($_smarty_tpl->tpl_vars['r']->value['ereason'],0,45,"utf-8");?>

											<?php if (strlen($_smarty_tpl->tpl_vars['r']->value['ereason'])>45) {?> 
												<a href="javascript:void(0);" onclick="showrea('宣讲会信息','<?php echo $_smarty_tpl->tpl_vars['r']->value['id'];?>
','error')" class="admin_cz_sc">[更多]</a>
											<?php }?>
										</td>
										<td align="left">
											<?php echo mb_substr($_smarty_tpl->tpl_vars['r']->value['rreason'],0,45,"utf-8");?>

											<?php if (strlen($_smarty_tpl->tpl_vars['r']->value['rreason'])>45) {?> 
												<a href="javascript:void(0);" onclick="showrea('宣讲会信息','<?php echo $_smarty_tpl->tpl_vars['r']->value['id'];?>
','right')" class="admin_cz_sc">[更多]</a>
											<?php }?>
										</td>
										<td class="td"><?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['r']->value['inputtime'],"%Y-%m-%d %H:%M");?>
</td>
