<?php /* Smarty version Smarty-3.1.21-dev, created on 2020-01-28 14:45:48
         compiled from "/www/fpwjob/uploads/app/template/ask/index.htm" */ ?>
<?php /*%%SmartyHeaderCode:2231981615e2fd89c10adc9-79137914%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e56d78f2c422b3838a9213e9ce26b96076b6f6f1' => 
    array (
      0 => '/www/fpwjob/uploads/app/template/ask/index.htm',
      1 => 1572067312,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2231981615e2fd89c10adc9-79137914',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5e2fd89c192a62_46215455',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5e2fd89c192a62_46215455')) {function content_5e2fd89c192a62_46215455($_smarty_tpl) {?><?php if (!is_callable('smarty_function_url')) include '/www/fpwjob/uploads/app/include/libs/plugins/function.url.php';
...
global $db,$db_config,$config;eval('$paramer=array("is_recom"=>"1","name"=>"\'list\'","ispage"=>"1","t_len"=>"30","limit"=>"5","item"=>"\'rlist\'","nocache"=>"")
;');$rlist=array();
		...
		if(count($rlist)){
			foreach($rlist as $key=>$val){
				...
				if($val['pic']&&file_exists(str_replace($config['sy_weburl'],APP_PATH,".".$val['pic']))){
					$rlist[$key]['pic']=$config["sy_weburl"]."/".$val['pic'];
				}else{
					$rlist[$key]['pic']=$config["sy_weburl"]."/".$config['sy_friend_icon'];
				}
...
global $db,$db_config,$config;eval('$paramer=array("item"=>"\'list\'","nonum"=>"\'auto.nonum\'","yesnum"=>"\'auto.yesnum\'","name"=>"\'list\'","ispage"=>"1","t_len"=>"30","limit"=>"10","nocache"=>"")
;');$list=array();
		$ParamerArr = GetSmarty($paramer,$_GET,$_smarty_tpl);
		$paramer = $ParamerArr[arr];
		$Purl =  $ParamerArr[purl];
...
global $db,$db_config,$config;eval('$paramer=array("limit"=>"6","son"=>"1","item"=>"\'qindex\'","nocache"=>"")
;');$qindex=array();
...
<dt><img class="" src="<?php echo $_smarty_tpl->tpl_vars['config']->value['sy_weburl'];?>
