<?php /* Smarty version Smarty-3.1.21-dev, created on 2020-01-28 06:10:11
         compiled from "/www/fpwjob/uploads/app/template/company/green/index.htm" */ ?>
<?php /*%%SmartyHeaderCode:1618708885e2f5fc33f9672-23997709%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a914ac4abae52207c133c6539be293d3c54f99be' => 
    array (
      0 => '/www/fpwjob/uploads/app/template/company/green/index.htm',
      1 => 1572067312,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1618708885e2f5fc33f9672-23997709',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5e2f5fc35b8e54_46294195',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5e2f5fc35b8e54_46294195')) {function content_5e2f5fc35b8e54_46294195($_smarty_tpl) {?><?php if (!is_callable('smarty_function_url')) include '/www/fpwjob/uploads/app/include/libs/plugins/function.url.php';
...
if (!is_callable('smarty_function_show')) include '/www/fpwjob/uploads/app/include/libs/plugins/function.show.php';
...
<div class="c_w_header">
  <div class="c_header_tou01">
    <div class="wrap">
      <div class="c_tou01_huany">
        <div class="c_huany_xt fl"><?php echo $_smarty_tpl->tpl_vars['com']->value['name'];?>
欢迎您！</div>
       <div class="fr"> <a href="<?php echo $_smarty_tpl->tpl_vars['config']->value['sy_weburl'];?>
" class="header_cont_home">返回人才网首页</a></div>
      </div>
    </div>
  </div>
   <div class="black_bg" >
  <div class="black_banner" ><img  src="<?php echo $_smarty_tpl->tpl_vars['banner']->value['pic'];?>
" onerror="showImgDelay(this,'<?php echo $_smarty_tpl->tpl_vars['config']->value['sy_weburl'];?>
/<?php echo $_smarty_tpl->tpl_vars['config']->value['sy_banner'];?>
',2);"> </div></div>
  <div class="black_cont">
  <div class="black_cont_cominfo">
  <div class="balck_logo"><div class="balck_logo_bg"><img src="<?php echo $_smarty_tpl->tpl_vars['com']->value['logo'];?>
" width="120" height="120" onerror="showImgDelay(this,'<?php echo $_smarty_tpl->tpl_vars['config']->value['sy_weburl'];?>
/<?php echo $_smarty_tpl->tpl_vars['config']->value['sy_unit_icon'];?>
',2);" />
  </div>  </div>
  <div class="black_cont_cominfo_right">
  <div class="black_cont_cominfo_nb">
  <h1 class="black_cont_cominfo_name"><?php echo $_smarty_tpl->tpl_vars['com']->value['name'];?>
</h1> 
...
' class="wrap_l_name_gz">取消关注</a> 
			  <?php } else { ?> 
			  <a href="javascript:void(0)" onclick="atn('<?php echo $_smarty_tpl->tpl_vars['com']->value['uid'];?>
','<?php echo smarty_function_url(array('m'=>'ajax','c'=>'atncompany'),$_smarty_tpl);?>
')" id='atn_<?php echo $_smarty_tpl->tpl_vars['com']->value['uid'];?>
' class="wrap_l_name_gz">关注</a> 
			  <?php }?>
          <?php } else { ?> 
...
?> 
    ...
    <div class="black_cont_bg"></div>
   </div>
   <div class="clear"></div>
      <div class="black_com_w980">
   <div class="black_com_box">
      <div class="black_com_box_left">
       <div class="black_com_box_tit none"  id="companybusiness"><span class="black_com_box_tit_s">工商信息</span></div>
...
<div class="business none" id="businessInfo">
  ...
  <div class="black_com_box_tit"><span class="black_com_box_tit_s">公司介绍</span></div>
   <div class="black_com_box_js"> <?php if ($_smarty_tpl->tpl_vars['com']->value['content']) {?><div style="width:100%;height:auto; overflow:hidden" id="com_content" class="company_img_auto">
<?php echo $_smarty_tpl->tpl_vars['com']->value['content'];?>

</div>
<div class="company_show_more none"><a href="javascript:;" onclick="showcc()">查看更多</a></div><?php } else { ?><div class="firm_tips_no">该企业还没有填写公司简介! </div><?php }?> </div>
     <div class="black_com_box_tit" style="padding-bottom:0px;"><span class="black_com_box_tit_s">招聘职位</span></div>
...
echo $_GET['page'];
              ...
              <div class="black_com_box_tit"><span class="black_com_box_tit_s">联系方式</span></div>
                <div class="black_com_box_content">    <?php if ($_smarty_tpl->tpl_vars['looktype']->value=="1") {?>
 <div class="firm_det_link"> 
    ...
    <?php if ($_smarty_tpl->tpl_vars['com']->value['linkphone']) {?> <span class="firm_mes1">固定电话：<i><?php echo $_smarty_tpl->tpl_vars['com']->value['linkphone'];?>
          ...
          <?php if ($_smarty_tpl->tpl_vars['com']->value['comqcode']) {?> <span class="firm_mes1" style="width:100%;">微信公众号：<i><img src="<?php echo $_smarty_tpl->tpl_vars['com']->value['comqcode'];?>
" width="120" height="120"></i></span> <?php }?>
          </div>
      <?php } else { ?>
      ...
      <div class="firm_login">
       ...
       <div class="firm_login">
        <div class="firm_login_con"> <span><?php echo $_smarty_tpl->tpl_vars['look_msg']->value;?>
</span>  <a href="<?php echo $_smarty_tpl->tpl_vars['config']->value['sy_weburl'];?>
/member/index.php?c=expect" class="firm_login_zc">创建简历</a></div>
      </div>
       <?php } elseif ($_smarty_tpl->tpl_vars['looktype']->value=="4") {?> 
       <div class="firm_login">
        <div class="firm_login_con"> <span><?php echo $_smarty_tpl->tpl_vars['look_msg']->value;?>
</span>  <a class="firm_login_dl" href="javascript:void(0);" onclick="showlogin('1');">立即登录</a> <a class="firm_login_zc" href="<?php echo smarty_function_url(array('m'=>'register','usertype'=>1,'type'=>1),$_smarty_tpl);?>
">立即注册</a></div>
      </div>
	  <?php }?> 
          <?php }?> </div><?php echo smarty_function_show(array(),$_smarty_tpl);?>

          <?php if (!empty($_smarty_tpl->tpl_vars['show']->value)) {?>
       <div class="black_com_box_tit"><span class="black_com_box_tit_s">企业环境</span></div>
       <div class="black_com_box_content"> 
          <ul class="black_hjlist"  id="layer-pic">
...
?>
            <li><a href='javascript:;'><img src="<?php echo $_smarty_tpl->tpl_vars['config']->value['sy_weburl'];?>
/<?php echo $_smarty_tpl->tpl_vars['row']->value['picurl'];?>
" width="200" height="127"  title="<?php echo $_smarty_tpl->tpl_vars['row']->value['title'];?>
"  layer-src="<?php echo $_smarty_tpl->tpl_vars['config']->value['sy_weburl'];?>
/<?php echo $_smarty_tpl->tpl_vars['row']->value['picurl'];?>
...
if (!empty($_smarty_tpl->tpl_vars['NewsList']->value)) {?>
         <div class="black_com_box_tit"><span class="black_com_box_tit_s">企业新闻</span></div>
                <div class="black_com_box_content"> 
...
" target="_blank"><?php echo $_smarty_tpl->tpl_vars['row']->value['title'];?>
        ...
        <?php } ?>
         ...
         </div><?php }?>  <?php if (!empty($_smarty_tpl->tpl_vars['ProductList']->value)) {?>
           <div class="black_com_box_tit"><span class="black_com_box_tit_s">企业产品</span></div>
...
"><?php echo $_smarty_tpl->tpl_vars['row']->value['title'];?>
      ...
      <?php } ?>
		...
		<?php if ($_smarty_tpl->tpl_vars['score']->value['num']) {?>
                       <div class="black_com_box_tit"><span class="black_com_box_tit_s">面试评价</span></div>
...
"><?php echo $_smarty_tpl->tpl_vars['keylist']->value['key_name'];?>
		...
		<div class="black_com_box_right">
		   <div class="black_com_box_tit"><span class="black_com_box_tit_s">投递查看</span></div>
		   <div class="black_com_lookreseme"><div class="black_com_lookreseme_n"><span class="black_com_lookreseme_n_n"><?php echo $_smarty_tpl->tpl_vars['pre']->value;?>
</span>%</div>简历回复率</div>
			   <div class="black_com_lookms"><div class="black_com_lookreseme_n"><span class="black_com_lookreseme_n_n"><?php echo $_smarty_tpl->tpl_vars['invite_resume']->value;?>
</span></div>邀请面试</div>
                 <div class="black_com_box_tit"><span class="black_com_box_tit_s">认证信息</span></div>
                <div class="">
  <?php if ($_smarty_tpl->tpl_vars['com']->value['email_status']=="1") {?> 
  <div class="rz_list"><img src="<?php echo $_smarty_tpl->tpl_vars['com_style']->value;?>
images/rz_yx2.png" alt="邮箱未认证" title="邮箱已认证" class="png" /> 
  已认证</div>
  <?php } else { ?>
  <div class="rz_list"> <img src="<?php echo $_smarty_tpl->tpl_vars['com_style']->value;?>
images/rz_yx.png" alt="邮箱未认证" title="邮箱未认证" class="png" />
   未认证</div>
    <?php }?>
     ...
     <div class="rz_list">   <img src="<?php echo $_smarty_tpl->tpl_vars['com_style']->value;?>
images/rz_sj2.png" alt="手机未认证" title="手机已认证" class="png" />
        已认证</div>
         <?php } else { ?> 
      <div class="rz_list">   <img src="<?php echo $_smarty_tpl->tpl_vars['com_style']->value;?>
images/rz_sj.png" alt="手机未认证" title="手机未认证" class="png" />
      ...
      <div class="rz_list">   <img src="<?php echo $_smarty_tpl->tpl_vars['com_style']->value;?>
images/rz_zz2.png" alt="执照未认证" title="执照已认证" class="png" /> 
        已认证</div>
        <?php } else { ?> 
      <div class="rz_list">  <img src="<?php echo $_smarty_tpl->tpl_vars['com_style']->value;?>
images/rz_zz.png" alt="执照未认证" title="执照未认证" class="png" /> 
        ...
        <?php }?>
		   ...
		   <div class="black_com_box_tit"><span class="black_com_box_tit_s">基本信息</span></div>
		   <div class="black_com_box_right_info">
...
if ($_smarty_tpl->tpl_vars['com']->value['moneytype']==1) {?>万元<?php } else { ?>万美元<?php }?></div><?php }?>
	  <?php if ($_smarty_tpl->tpl_vars['com']->value['sdate']) {?><div class="c_nr_hy"><em>创办</em><?php echo $_smarty_tpl->tpl_vars['com']->value['sdate'];?>
           ...
           <div class="black_com_box_tit"><span class="black_com_box_tit_s">分享到朋友圈</span></div>
...
if(li_num>3){
	...
	scrollPic_02.frameWidth     = 630;
	scrollPic_02.pageWidth      = 210; 
...
');
	...
	$('.c_zj02_list li').click(function () {
		$(this).addClass('c_zj02_curr').siblings().removeClass('c_zj02_curr');
	});
