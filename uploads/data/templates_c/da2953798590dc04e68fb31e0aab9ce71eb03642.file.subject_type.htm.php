<?php /* Smarty version Smarty-3.1.21-dev, created on 2020-02-16 16:16:49
         compiled from "/www/fpwjob/uploads/app/template/admin/subject_type.htm" */ ?>
<?php /*%%SmartyHeaderCode:3616146245e48fa71eaf009-09472539%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'da2953798590dc04e68fb31e0aab9ce71eb03642' => 
    array (
      0 => '/www/fpwjob/uploads/app/template/admin/subject_type.htm',
      1 => 1572067312,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '3616146245e48fa71eaf009-09472539',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5e48fa71f005b2_81391650',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5e48fa71f005b2_81391650')) {function content_5e48fa71f005b2_81391650($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<html>
<head>
...
<div class="admin_new_tip">
    ...
    <div class="admin_new_tip_list_cont">
      <div class="admin_new_tip_list">该页面展示了网站开课类型信息，可对开课类型编辑修改操作。</div>
    </div>
  </div>
  <div class="admin_new_search_box">
  <a   href="javascript:void(0)" onClick="add_class('添加类型','450','240','#houtai_div','')"  class="admin_new_cz_tj" style="margin-left:0px;">+ 添加类别</a>
  </div>
  <div class="clear"></div>
...
<form action="index.php?m=subject_type&c=del" method="post" target="supportiframe" id='myform'>  
...
<table width="100%" id="table_industry">
	...
	<tr class="admin_table_top">
		...
		<th width="60">编号</th>
		<th align="left">开课类型名称<span class="clickup">(点击修改)</span></th>
		<th>排序（越大越靠前）</th>
...
','index.php?m=subject_type&c=ajax');" >
...
');"/></td>
		<td class="ud">
        <a href="javascript:void(0)" onClick="layer_del('确定要删除？', 'index.php?m=subject_type&c=del&delid=<?php echo $_smarty_tpl->tpl_vars['v']->value['id'];?>
...
<div class="admin_mt10">
   <table cellspacing='1' cellpadding='1' class="admin_examine_table">
		<tbody>
			<tr >
				<th width="90">类型名称：</th><td><textarea  id='position' class="add_class_textarea"></textarea></td>
			</tr>
			<tr class="ui_td_11">
			...
			<tr class="ui_td_11">
                ...
                <input class="admin_examine_bth"  type="button" name="add" value=" 添加 " onClick="save_dclass('index.php?m=subject_type&c=add')" /></td>
			</tr> 
		</tbody>
	</table>
</div>   
