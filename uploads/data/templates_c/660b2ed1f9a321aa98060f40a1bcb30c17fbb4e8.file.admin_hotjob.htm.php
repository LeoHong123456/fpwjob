<?php /* Smarty version Smarty-3.1.21-dev, created on 2020-01-27 17:18:28
         compiled from "/www/fpwjob/uploads/app/template/admin/admin_hotjob.htm" */ ?>
<?php /*%%SmartyHeaderCode:16910457335e2eaae48563e3-69304311%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '660b2ed1f9a321aa98060f40a1bcb30c17fbb4e8' => 
    array (
      0 => '/www/fpwjob/uploads/app/template/admin/admin_hotjob.htm',
      1 => 1572067312,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '16910457335e2eaae48563e3-69304311',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5e2eaae4920de3_79920300',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5e2eaae4920de3_79920300')) {function content_5e2eaae4920de3_79920300($_smarty_tpl) {?><?php if (!is_callable('smarty_function_searchurl')) include '/www/fpwjob/uploads/app/include/libs/plugins/function.searchurl.php';
			...
			<td>
				<div class="admin_table_w84">
					<?php if ($_smarty_tpl->tpl_vars['v']->value['time_end']<=time()) {?>
						<b style="color:red;"><?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['v']->value['time_end'],"%Y-%m-%d");?>
<br>已到期</b>
					<?php } else { ?>
...
');" class="admin_new_c_bth admin_new_c_bthxg">修改</a> <a href="javascript:void(0);" onClick="layer_del('确定要取消该名企？','index.php?m=admin_hotjob&c=del&id=<?php echo $_smarty_tpl->tpl_vars['v']->value['uid'];?>
