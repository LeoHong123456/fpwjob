<?php /* Smarty version Smarty-3.1.21-dev, created on 2020-01-27 17:18:02
         compiled from "/www/fpwjob/uploads/app/template/admin/admin_company_job.htm" */ ?>
<?php /*%%SmartyHeaderCode:13963584335e2eaaca4c2619-53328015%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f7862dea913387206b289c78d051345fa8a44efe' => 
    array (
      0 => '/www/fpwjob/uploads/app/template/admin/admin_company_job.htm',
      1 => 1572067312,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '13963584335e2eaaca4c2619-53328015',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5e2eaaca5c7e74_40064537',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5e2eaaca5c7e74_40064537')) {function content_5e2eaaca5c7e74_40064537($_smarty_tpl) {?><?php if (!is_callable('smarty_function_searchurl')) include '/www/fpwjob/uploads/app/include/libs/plugins/function.searchurl.php';
...
">
    <div class=" admin_com_smbox_list_b"> <span class="admin_com_smbox_span">置顶天数：</span>
      ...
      <span class="admin_com_smbox_list_s">天</span> </div>
    <div class="xsdiv" style="display:none"> <span class="admin_com_smbox_span">当前结束日期：</span> <span class="admin_com_smbox_list_s xsdate" style="colo2r:#f60"></span> </div>
...
">编号<img src="images/sanj2.jpg"/></a></th>
						...
						<th align="left" width="180">公司名称/会员等级</th>
						<th>简历</th>
						<th>发布/更新时间</th>
						<th>浏览量</th>
						<th>来源</th>
...
" class="check_all" name='del[]' onclick='unselectall()' rel="del_chk" />
								...
								<td align="left">
									<a href="<?php echo smarty_function_url(array('m'=>'job','c'=>'comapply','id'=>$_smarty_tpl->tpl_vars['v']->value['id'],'look'=>'admin'),$_smarty_tpl);?>
...
" target="_blank" class="admin_cz_sc"><?php echo $_smarty_tpl->tpl_vars['v']->value['com_name'];?>
										...
										<?php if ($_smarty_tpl->tpl_vars['v']->value['c_status']!=1) {?>
											<a href="javascript:void(0)" class="job_name_all"  v="<?php if ($_smarty_tpl->tpl_vars['v']->value['c_status']==0) {?>企业未审核<?php } elseif ($_smarty_tpl->tpl_vars['v']->value['c_status']==3) {?>审核未通过<?php } elseif ($_smarty_tpl->tpl_vars['v']->value['c_status']==2) {?>企业已锁定<?php }?>">
								...
								<td> 
									...
									<?php } elseif ($_smarty_tpl->tpl_vars['v']->value['state']==3) {?> <span class="admin_com_tg">未通过</span> 
									<?php }?> 
								</td>
...
" class="admin_new_c_bth admin_new_c_bth_pp">匹配</a> 
									</div>
