<?php /* Smarty version Smarty-3.1.21-dev, created on 2020-02-16 16:15:49
         compiled from "/www/fpwjob/uploads/app/template/admin/admin_web_config.htm" */ ?>
<?php /*%%SmartyHeaderCode:16771830425e48fa35ce6542-55064025%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7cd73f4d15841a1773f92c124191f3f2f37bdc90' => 
    array (
      0 => '/www/fpwjob/uploads/app/template/admin/admin_web_config.htm',
      1 => 1573270385,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '16771830425e48fa35ce6542-55064025',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5e48fa35e2cc45_62309853',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5e48fa35e2cc45_62309853')) {function content_5e48fa35e2cc45_62309853($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<html>
<head>
...
<div class="admin_new_tip_list">管理员设置后轻松掌控网站运营、企业、猎头和培训相关设置。请谨慎设置关系到网站运营和收入情况。</div>
</div>
</div>
<div class="clear"></div>
...
" style="max-width:300px;" <?php if (!$_smarty_tpl->tpl_vars['config']->value['sy_lt_logo']) {?>class="none"<?php }?>>
          </td>
...
" style="max-width:300px;" <?php if (!$_smarty_tpl->tpl_vars['config']->value['sy_ltmember_logo']) {?>class="none"<?php }?>>
          </td>
    </tr>
    
     <tr class="admin_table_trbg">  
    <th width="160">培训LOGO：<br/>300px X 45px</th>
    <td>
		<button type="button" class="yun_bth_pic adminupload" lay-data="{name: 'sy_px_logo',imgid: 'imgpx'}">上传图片</button>
		<input type="hidden" name="sy_px_logo" value="<?php echo $_smarty_tpl->tpl_vars['config']->value['sy_px_logo'];?>
"/>
        <img id="imgpx" src="<?php echo $_smarty_tpl->tpl_vars['config']->value['sy_weburl'];?>
/<?php echo $_smarty_tpl->tpl_vars['config']->value['sy_px_logo'];?>
" style="max-width:300px;" <?php if (!$_smarty_tpl->tpl_vars['config']->value['sy_px_logo']) {?>class="none"<?php }?>>
          </td>
    </tr>
        <tr>  
...
" style="max-width:100px;" <?php if (!$_smarty_tpl->tpl_vars['config']->value['sy_androidu_qcode']) {?>class="none"<?php }?>>
          </td>
    </tr>
    <tr>  
...
" style="max-width:100px;" <?php if (!$_smarty_tpl->tpl_vars['config']->value['sy_iosu_qcode']) {?>class="none"<?php }?>>
          </td>
    </tr> 
	 <tr class="admin_table_trbg"> 
    <th width="160">招聘会缩略图：</th>
    <td>
		<button type="button" class="yun_bth_pic adminupload" lay-data="{name: 'sy_zph_icon',imgid: 'imgzph'}">上传图片</button>
		<input type="hidden" name="sy_zph_icon" value="<?php echo $_smarty_tpl->tpl_vars['config']->value['sy_zph_icon'];?>
"/>
        <img id="imgzph" src="<?php echo $_smarty_tpl->tpl_vars['config']->value['sy_weburl'];?>
...
" style="max-width:100px;" <?php if (!$_smarty_tpl->tpl_vars['config']->value['sy_zph_icon']) {?>class="none"<?php }?>>
    ...
    <td>
		<button type="button" class="yun_bth_pic adminupload" lay-data="{name: 'sy_zphbanner_icon',imgid: 'imgzphbanner'}">上传图片</button>
		<input type="hidden" name="sy_zphbanner_icon" value="<?php echo $_smarty_tpl->tpl_vars['config']->value['sy_zphbanner_icon'];?>
"/>
        <img id="imgzphbanner" src="<?php echo $_smarty_tpl->tpl_vars['config']->value['sy_weburl'];?>
...
" style="max-width:100px;" <?php if (!$_smarty_tpl->tpl_vars['config']->value['sy_zphbanner_icon']) {?>class="none"<?php }?>>
    ...
    <td>
		<button type="button" class="yun_bth_pic adminupload" lay-data="{name: 'sy_cplogo',imgid: 'cpimglogo'}">上传图片</button>
		
		<input type="hidden" name="sy_cplogo" value="<?php echo $_smarty_tpl->tpl_vars['config']->value['sy_cplogo'];?>
"/>
        <img id="cpimglogo" src="<?php echo $_smarty_tpl->tpl_vars['config']->value['sy_weburl'];?>
