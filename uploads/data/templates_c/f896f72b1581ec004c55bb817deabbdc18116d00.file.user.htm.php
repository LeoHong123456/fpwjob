<?php /* Smarty version Smarty-3.1.21-dev, created on 2020-01-29 11:36:12
         compiled from "/www/fpwjob/uploads/app/template/default/register/user.htm" */ ?>
<?php /*%%SmartyHeaderCode:17092638165e30fdaca55404-51490663%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f896f72b1581ec004c55bb817deabbdc18116d00' => 
    array (
      0 => '/www/fpwjob/uploads/app/template/default/register/user.htm',
      1 => 1572067313,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '17092638165e30fdaca55404-51490663',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5e30fdacf2ec27_95419294',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5e30fdacf2ec27_95419294')) {function content_5e30fdacf2ec27_95419294($_smarty_tpl) {?><?php if (!is_callable('smarty_function_url')) include '/www/fpwjob/uploads/app/include/libs/plugins/function.url.php';
...
/app/include/authcode.inc.php" /></a>
                            ...
                            <li class="mt30 reg_re2"><em><font color="#FF0000">*</font> 真实姓名：</em>
                                <input type="text" class="logoin_text tips_class" id="name" onblur="reg_checkAjax('name');" placeholder="请输入您的真实姓名" />
...
/app/include/authcode.inc.php" /></a>
                            ...
                            <li class="mt30"><em>&nbsp;</em><input type="button" class="register_submit" <?php if ($_smarty_tpl->tpl_vars['config']->value['reg_real_name_check']=='0') {?> id='subreg' <?php }?> value="立即注册" onclick="check_user(3,'vcodeimg');" /></li>
                            <li class="m10">
                                <em>&nbsp;</em>
                                <div class="reg_xy">
                                    点击注册即表示您同意
...
/app/include/authcode.inc.php" /></a>
                            ...
                            <?php }?>  <?php if ($_smarty_tpl->tpl_vars['config']->value['reg_username']=='1'||$_smarty_tpl->tpl_vars['config']->value['reg_real_name_check']=="1") {?>
                            <li class="mt30 reg_re2"><em><font color="#FF0000">*</font> 真实姓名：</em>
                                <input type="text" class="logoin_text tips_class" id="name" onblur="reg_checkAjax('name');" placeholder="请确认您的真实姓名" />
                                <span class="reg_tips reg_tips_red none" id="ajax_name"></span>
                            </li>
                            <?php }?> <?php if ($_smarty_tpl->tpl_vars['config']->value['reg_useremail']=='1') {?>
                            <li class="mt30 reg_re2"><em><font color="#FF0000">*</font> 邮&nbsp;&nbsp;箱：</em>
