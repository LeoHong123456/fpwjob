<?php /* Smarty version Smarty-3.1.21-dev, created on 2020-02-19 20:42:23
         compiled from "/www/fpwjob/uploads/app/template/admin/admin_saveresume.htm" */ ?>
<?php /*%%SmartyHeaderCode:12648939425e4d2d2f7c62f5-93947593%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5f47a8e567dc53f2e62bdede83ecde116ca648c9' => 
    array (
      0 => '/www/fpwjob/uploads/app/template/admin/admin_saveresume.htm',
      1 => 1572067312,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '12648939425e4d2d2f7c62f5-93947593',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5e4d2d2f966037_34348011',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5e4d2d2f966037_34348011')) {function content_5e4d2d2f966037_34348011($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/www/fpwjob/uploads/app/include/libs/plugins/modifier.date_format.php';
...
function saveexpect(){
	...
	if(city_classid==''){parent.layer.msg('请选择工作地点！', 2, 8);return false;}
	...
	$.post("index.php?m=admin_resume&c=saveexpect",{name:name,hy:hy,job_classid:job_classid,city_classid:city_classid,minsalary:minsalary,maxsalary:maxsalary,report:report,eid:eid,submit:"1",uid:uid,pytoken:pytoken,type:typeid,jobstatus:jobstatus},function(data){
...
function savework(){
	...
	parent.layer.load('执行中，请稍候...',0);
	$.post("index.php?m=admin_resume&c=work",{sdate:sdate,edate:edate,name:name,eid:eid,title:title,content:content,id:id,table:"resume_work",submit:"1",uid:uid,pytoken:pytoken},function(data){
		parent.layer.closeAll('loading');
		if(data!=0){
			data=eval('('+data+')');
			$("#work").show();
...
function saveproject(){
	...
	parent.layer.load('执行中，请稍候...',0);
	$.post("index.php?m=admin_resume&c=project",{sdate:sdate,edate:edate,name:name,eid:eid,title:title,content:content,id:id,table:"resume_project",submit:"1",uid:uid,pytoken:pytoken},function(data){
		parent.layer.closeAll('loading');
		if(data!=0){
			data=eval('('+data+')');
			$("#project").show();
...
function getresume(type,id){ 
	...
	$.post("index.php?m=admin_resume&c=resume_ajax",{type:type,id:id,pytoken:pytoken},function(data){
		...
		if(type=="training"){
			...
			$("#training_date").val(data.sdate+' ~ '+data.edate);
		...
		<form class="layui-form">
			<div class="admin_resume_box">
				<div class="admin_add_list">
					<div class="admin_add_list_name">期望岗位</div>
...
" name="job_class">
							<input type="button" id="workadds_job"  value="<?php if ($_smarty_tpl->tpl_vars['job_classname']->value) {
echo $_smarty_tpl->tpl_vars['job_classname']->value;
} else { ?>请选择职位<?php }?>" class="expect_text" onclick="index_job_new(5,'#workadds_job','#job_class','left:100px;top:100px; position:absolute;','1');" readonly="readonly" />
						</div>
					</div>
				</div>
...
echo $_smarty_tpl->tpl_vars['row']->value['maxsalary'];
				...
				<div class="admin_add_list">
					...
					<div class="admin_add_list_right">
						<div class="layui-form-item">
							<div class="layui-input-inline">
							<input type="button" class="expect_text" id="workadds_city" value="<?php if ($_smarty_tpl->tpl_vars['city_classname']->value) {
echo $_smarty_tpl->tpl_vars['city_classname']->value;
} else { ?>请选择工作地点<?php }?>" onclick="index_city_new(5,'#workadds_city','#city_class','','<?php echo $_smarty_tpl->tpl_vars['row']->value['city_classid'];?>
');"/>
...
?>
											<option value="<?php echo $_smarty_tpl->tpl_vars['v']->value;?>
" <?php if ($_smarty_tpl->tpl_vars['row']->value['report']==$_smarty_tpl->tpl_vars['v']->value) {?> selected <?php }?>><?php echo $_smarty_tpl->tpl_vars['userclass_name']->value[$_smarty_tpl->tpl_vars['v']->value];?>
 </option>
										<?php } ?>
									</select>
								</div>
...
?>
											<option  value="<?php echo $_smarty_tpl->tpl_vars['v']->value;?>
" <?php if ($_smarty_tpl->tpl_vars['row']->value['type']==$_smarty_tpl->tpl_vars['v']->value) {?> selected <?php }?>> <?php echo $_smarty_tpl->tpl_vars['userclass_name']->value[$_smarty_tpl->tpl_vars['v']->value];?>
 </option>
										<?php } ?>
									</select>
								</div>
...
?>
											<option value="<?php echo $_smarty_tpl->tpl_vars['v']->value;?>
" <?php if ($_smarty_tpl->tpl_vars['row']->value['jobstatus']==$_smarty_tpl->tpl_vars['v']->value) {?> selected <?php }?>> <?php echo $_smarty_tpl->tpl_vars['userclass_name']->value[$_smarty_tpl->tpl_vars['v']->value];?>
 </option>
										<?php } ?>
									</select>
								</div>
	...
	<div id='resume' <?php if ($_smarty_tpl->tpl_vars['row']->value['id']=='') {?> style='display:none'<?php }?>>
		<div class="admin_saveresume_list">
			<div class="admin_saveresume_list_name">期望岗位：</div>
		...
		<div class="admin_saveresume_list">
			...
			<div id="salary_html">
				<div class="admin_td_h">
					<?php if ($_smarty_tpl->tpl_vars['row']->value['maxsalary']) {?>
						￥<?php echo $_smarty_tpl->tpl_vars['row']->value['minsalary'];?>
...
以上
		...
		<div class="admin_saveresume_list">
			...
			<div id="cityid_html">
				<div class="admin_td_h"><?php echo $_smarty_tpl->tpl_vars['city_classname']->value;?>
</div>
			</div>
		</div>
...
echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['work_l']->value['edate'],"%Y-%m");
							...
							<div class="admin_saversume_cz"> 
								<a href="javascript:void(0)" onclick="getresume('work','<?php echo $_smarty_tpl->tpl_vars['work_l']->value['id'];?>
')"class="admin_new_c_bth">修改</a> 
								<a href="javascript:void(0)" onclick="resume_del('work','<?php echo $_smarty_tpl->tpl_vars['work_l']->value['id'];?>
	...
	<div id='addwork' style="display:none">
		<div class="admin_resume_box">
			...
			<div class="admin_add_list">
				...
				<div class="admin_add_list_right">
					<input class="input-text  text_resume_date " type="text" name="work_sdate" value="<?php if ($_smarty_tpl->tpl_vars['v']->value['sdate']!='') {
echo $_smarty_tpl->tpl_vars['v']->value['sdate'];
}?>" size="15"  id="work_sdate"/>
					-
					<input class="input-text  text_resume_date " type="text" name="work_edate" value="<?php if ($_smarty_tpl->tpl_vars['v']->value['edate']!='') {
echo $_smarty_tpl->tpl_vars['v']->value['edate'];
}?>" size="15"  id="work_edate"/>
				
					<input type='checkbox' value='1' id='work_totoday' onClick="untiltoday('work');"<?php if ($_smarty_tpl->tpl_vars['v']->value['edate']=='0') {?>checked<?php }?>>
...
">
 ...
 - <?php if ($_smarty_tpl->tpl_vars['edu_l']->value['edate']) {
echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['edu_l']->value['edate'],"%Y-%m");
} else { ?>至今<?php }?></div>
					<div> 
						<?php if ($_smarty_tpl->tpl_vars['userclass_name']->value[$_smarty_tpl->tpl_vars['edu_l']->value['education']]) {?> 
							最高学历：<?php echo $_smarty_tpl->tpl_vars['userclass_name']->value[$_smarty_tpl->tpl_vars['edu_l']->value['education']];?>
				...
				<div class="admin_saversume_cz"> 
					<a href="javascript:void(0)" onclick="getresume('edu','<?php echo $_smarty_tpl->tpl_vars['edu_l']->value['id'];?>
')"class="admin_new_c_bth">修改</a> 
					<a href="javascript:void(0)" onclick="resume_del('edu','<?php echo $_smarty_tpl->tpl_vars['edu_l']->value['id'];?>
')" class="admin_new_c_bth admin_new_c_bth_sc">删除</a> 
				</div>
			</div>
		<?php } ?>
	...
	<div id='addedu' style="display:none">
		<div class="admin_resume_box">
			...
			<div class="admin_add_list">
				...
				<div class="admin_add_list_right">
					<input class="input-text text_resume_date " type="text" name="edu_sdate" value="<?php if ($_smarty_tpl->tpl_vars['v']->value['sdate']!='') {
echo $_smarty_tpl->tpl_vars['v']->value['sdate'];
}?>" size="15"  id="edu_sdate"/>
					-
					<input class="input-text text_resume_date " type="text" name="edu_edate" value="<?php if ($_smarty_tpl->tpl_vars['v']->value['edate']!='') {
echo $_smarty_tpl->tpl_vars['v']->value['edate'];
