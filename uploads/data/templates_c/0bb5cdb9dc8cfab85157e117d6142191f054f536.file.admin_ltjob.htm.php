<?php /* Smarty version Smarty-3.1.21-dev, created on 2020-02-16 16:16:46
         compiled from "/www/fpwjob/uploads/app/template/admin/admin_ltjob.htm" */ ?>
<?php /*%%SmartyHeaderCode:9347448225e48fa6e41b863-39033670%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0bb5cdb9dc8cfab85157e117d6142191f054f536' => 
    array (
      0 => '/www/fpwjob/uploads/app/template/admin/admin_ltjob.htm',
      1 => 1572067312,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '9347448225e48fa6e41b863-39033670',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5e48fa6e49ed71_96823792',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5e48fa6e49ed71_96823792')) {function content_5e48fa6e49ed71_96823792($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<html>
<head>
...
<div class="admin_new_tip">
    ...
    <div class="admin_new_tip_list_cont">
      <div class="admin_new_tip_list">该页面展示了网站猎头职位类别信息，可对猎头职位类别编辑修改操作。</div>
    </div>
  </div>
  <div class="admin_new_search_box">
  <a href="javascript:void(0)" onClick="add_class('猎头职位分类','450','360','#bname','index.php?m=ltjob_class&c=save')" class="admin_new_cz_tj" style="margin-left:0px;">+ 添加类别</a>
  </div>
  <div class="clear"></div>
...
<form action="index.php?m=ltjob_class&c=del" method="post" id='myform' target="supportiframe">  
<table width="100%">
	<thead>
...
','index.php?m=ltjob_class&c=ajax');"/>
...
');"/></td>
		<td class="ud">
            <A href="index.php?m=ltjob_class&c=up&id=<?php echo $_smarty_tpl->tpl_vars['v']->value['id'];?>
" class="admin_new_c_bth">管理</A>
            <A href="javascript:void(0)" onClick="layer_del('确定要删除？', 'index.php?m=ltjob_class&c=del&delid=<?php echo $_smarty_tpl->tpl_vars['v']->value['id'];?>
...
');"/>
		...
		<td class="ud" width="180"><A href="javascript:void(0)" onClick="layer_del('确定要删除？', 'index.php?m=ltjob_class&c=del&delid=<?php echo $_smarty_tpl->tpl_vars['onejob']->value['id'];?>
...
');"/></td>
		<td class="ud"><A href="javascript:void(0)" onClick="layer_del('确定要删除？', 'index.php?m=ltjob_class&c=del&delid=<?php echo $_smarty_tpl->tpl_vars['two']->value['id'];?>
');"class="admin_new_c_bth admin_new_c_bth_sc">删除</a> </td>
	</tr>
