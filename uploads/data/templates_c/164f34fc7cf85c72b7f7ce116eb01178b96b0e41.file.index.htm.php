<?php /* Smarty version Smarty-3.1.21-dev, created on 2019-11-08 21:00:53
         compiled from "/www/fpwjob/uploads/app/template/wap/job/index.htm" */ ?>
<?php /*%%SmartyHeaderCode:19235011165dc567051fa058-68075873%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '164f34fc7cf85c72b7f7ce116eb01178b96b0e41' => 
    array (
      0 => '/www/fpwjob/uploads/app/template/wap/job/index.htm',
      1 => 1572067313,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '19235011165dc567051fa058-68075873',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5dc5670528b473_26279320',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5dc5670528b473_26279320')) {function content_5dc5670528b473_26279320($_smarty_tpl) {?><?php if (!is_callable('smarty_function_url')) include '/www/fpwjob/uploads/app/include/libs/plugins/function.url.php';
?><!DOCTYPE html>
<html lang="zh-CN">
<head>
<meta charset="utf-8">
...
/images/btn01_arrow.png" /></section>
        <div class="tem_tit">
        	<div class="tem_tit_con">
            	<h3 style="width:70%;"><a href="<?php echo smarty_function_url(array('m'=>'wap','c'=>'job','a'=>'view','id'=>$_smarty_tpl->tpl_vars['job']->value['id']),$_smarty_tpl);?>
                 ...
                 <li class="shaft_con2">
                  ...
                  <li class="shaft_con3">
                      ...
                      <?php if ($_smarty_tpl->tpl_vars['job']->value['salary']) {?>
                          <span class="shaft_pay"> 月薪：<b> <?php if ($_smarty_tpl->tpl_vars['job']->value['minsalary']&&$_smarty_tpl->tpl_vars['job']->value['maxsalary']) {?>￥<?php echo $_smarty_tpl->tpl_vars['job']->value['minsalary'];?>
-<?php echo $_smarty_tpl->tpl_vars['job']->value['maxsalary'];
} elseif ($_smarty_tpl->tpl_vars['job']->value['minsalary']) {?>￥<?php echo $_smarty_tpl->tpl_vars['job']->value['minsalary'];?>
以上<?php } else { ?>面议<?php }?> </b></span>
                           <?php }?>
                           <?php if ($_smarty_tpl->tpl_vars['job']->value['exp']) {?>
                          <span>经验：<?php echo $_smarty_tpl->tpl_vars['comclass_name']->value[$_smarty_tpl->tpl_vars['job']->value['exp']];?>
</span>
                          <?php }?>
                           <?php if ($_smarty_tpl->tpl_vars['job']->value['edu']) {?>
                          <span>学历：<?php echo $_smarty_tpl->tpl_vars['comclass_name']->value[$_smarty_tpl->tpl_vars['job']->value['edu']];?>
</span>
                          <?php }?>
                           <?php if ($_smarty_tpl->tpl_vars['job']->value['report']) {?>
                          <span>  到岗：<?php echo $_smarty_tpl->tpl_vars['comclass_name']->value[$_smarty_tpl->tpl_vars['job']->value['report']];?>
 </span>
                          <?php }?>
                           <?php if ($_smarty_tpl->tpl_vars['job']->value['age']) {?>
                          <span> 年龄：<?php echo $_smarty_tpl->tpl_vars['comclass_name']->value[$_smarty_tpl->tpl_vars['job']->value['age']];?>
</span>
                          <?php }?>
                           <?php if ($_smarty_tpl->tpl_vars['job']->value['sex']) {?>
                          <span>性别：<?php echo $_smarty_tpl->tpl_vars['job']->value['sex'];?>
</span>
                          <?php }?>
                           <?php if ($_smarty_tpl->tpl_vars['job']->value['number']) {?>
                          <span> 招聘：<?php echo $_smarty_tpl->tpl_vars['comclass_name']->value[$_smarty_tpl->tpl_vars['job']->value['number']];?>
 </span>
                          <?php }?>
                           <?php if ($_smarty_tpl->tpl_vars['job']->value['marriage']) {?>
                          <span>  婚姻：<?php echo $_smarty_tpl->tpl_vars['comclass_name']->value[$_smarty_tpl->tpl_vars['job']->value['marriage']];?>
</span>
                          <?php }?>
                           <?php if ($_smarty_tpl->tpl_vars['job']->value['provinceid']) {?>
                          <span class="shaft_pay">城市：<?php echo $_smarty_tpl->tpl_vars['city_name']->value[$_smarty_tpl->tpl_vars['job']->value['provinceid']];?>
...
if (strlen($_smarty_tpl->tpl_vars['job']->value['description'])>180) {?><a href="<?php echo smarty_function_url(array('m'=>'wap','c'=>'job','a'=>'view','id'=>$_smarty_tpl->tpl_vars['job']->value['id']),$_smarty_tpl);?>
" >更多</a><?php }?>
                      </div>
                  </li>
		...
		<div class="shaft app">
			<ul>
				...
				<?php if ($_smarty_tpl->tpl_vars['look_msg']->value=="2") {?>
					<li class="app_con1">
                  		<div class="app_det1"> 
                    		<span>企业没有开放联系信息；请直接申请职位！</span> 
						</div>
					</li>
				<?php } elseif ($_smarty_tpl->tpl_vars['look_msg']->value=="3") {?>
					<li class="app_con1">	
						<div class="app_det1">请登录才可以查看联系方式</div>
						<div class="app_det1">
...
"  class="app_det1_bb">注册</a>
				...
				<?php } elseif ($_smarty_tpl->tpl_vars['look_msg']->value=="31") {?>
					<li class="app_con1">
                  		<div class="app_det1"> 
                    		<span>只有个人用户才可以查看联系方式！</span> 
						</div>
					</li>
				<?php } elseif ($_smarty_tpl->tpl_vars['look_msg']->value=="4") {?>
					<li class="app_con1">
                  		<div class="app_det1"> 
                    		<span>您还没有创建简历，不能查看联系方式！</span> 
						</div>
					</li>
					...
					<li class="app_con1">
                  		<div class="app_det1">
							...
							<?php if ($_smarty_tpl->tpl_vars['company']->value['linkphone']) {?>
								<span> 联系电话：<?php echo $_smarty_tpl->tpl_vars['company']->value['linkphone'];?>
</span>
							<?php }?>
...
"><?php echo $_smarty_tpl->tpl_vars['company']->value['name'];?>
                      ...
                      <div class="shaft_det5 shaft_det7">
                        <?php echo mb_substr($_smarty_tpl->tpl_vars['company']->value['content'],0,145,'utf-8');?>

                        <?php if (strlen($_smarty_tpl->tpl_vars['company']->value['content'])>145) {?><a href="<?php echo smarty_function_url(array('m'=>'wap','c'=>'company','a'=>'show','id'=>$_smarty_tpl->tpl_vars['job']->value['uid']),$_smarty_tpl);?>
" >更多</a><?php }?>
                       </div>
                  </li>
...
"><?php echo $_smarty_tpl->tpl_vars['wlist']->value;?>
                ...
                <li class="daz_g4">
                	<div class="daz_gcon4">
                    	<a href="<?php echo smarty_function_url(array('m'=>'wap','c'=>'job','a'=>'view','id'=>$_smarty_tpl->tpl_vars['job']->value['id']),$_smarty_tpl);?>
">申请此职位</a>
                    </div>
                </li>
            </ul>
