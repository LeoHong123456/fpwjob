<?php /* Smarty version Smarty-3.1.21-dev, created on 2020-02-16 18:05:05
         compiled from "/www/fpwjob/uploads/app/template/wap/reg_user.htm" */ ?>
<?php /*%%SmartyHeaderCode:2458055195e4913d1513584-32194980%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e822a15cf20c18f97f0006c732e25d3576e77e49' => 
    array (
      0 => '/www/fpwjob/uploads/app/template/wap/reg_user.htm',
      1 => 1572067313,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2458055195e4913d1513584-32194980',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5e4913d16178b1_21592493',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5e4913d16178b1_21592493')) {function content_5e4913d16178b1_21592493($_smarty_tpl) {?><?php if (!is_callable('smarty_function_url')) include '/www/fpwjob/uploads/app/include/libs/plugins/function.url.php';
...
账号</dd>
            ...
            <div class="regform">
                <ul class="regtab">
                    ...
                    <li class="<?php if ($_smarty_tpl->tpl_vars['type']->value!='1'&&$_smarty_tpl->tpl_vars['type']->value!=3) {?>current<?php }?>">
                        <a href="<?php echo smarty_function_url(array('m'=>'wap','c'=>'register','usertype'=>1,'type'=>2),$_smarty_tpl);?>
" style="display:block;">手机注册</a>
                    </li>
                    <?php }?> <?php if ($_smarty_tpl->tpl_vars['config']->value['reg_email']=='1') {?>
                    <li class="<?php if ($_smarty_tpl->tpl_vars['type']->value=='3') {?>current<?php }?>">
                        <a href="<?php echo smarty_function_url(array('m'=>'wap','c'=>'register','usertype'=>1,'type'=>3),$_smarty_tpl);?>
" style="display:block;">邮箱注册</a>
                    </li>
                    <?php }?> <?php if ($_smarty_tpl->tpl_vars['config']->value['reg_user']=='1') {?>
                    <li class="<?php if ($_smarty_tpl->tpl_vars['type']->value==1) {?>current<?php }?>">
                        <a href="<?php echo smarty_function_url(array('m'=>'wap','c'=>'register','usertype'=>1,'type'=>1),$_smarty_tpl);?>
" style="display:block;">用户名注册</a>
                    </li>
                    <?php }?>
                </ul>
...
/authcode.inc.php" onclick="checkCode('vcodeimg');" />
                        ...
                        <?php }?> <?php if ($_smarty_tpl->tpl_vars['config']->value['reg_usertel']=='1'||$_smarty_tpl->tpl_vars['config']->value['reg_real_name_check']==1) {?>
                        <dd>
                            <div class="c ico_name inputitem_w">
                        ...
                        <?php }?> <?php if ($_smarty_tpl->tpl_vars['config']->value['reg_username']=='1'||$_smarty_tpl->tpl_vars['config']->value['reg_real_name_check']==1) {?>
                        <dd>
                            <div class="c ico_name inputitem_w">
                        ...
                        <?php }?> <?php } elseif ($_smarty_tpl->tpl_vars['type']->value==2||$_smarty_tpl->tpl_vars['type']->value=='') {?>
                        <dd>
                            <div class="c ico_name inputitem_w">
                                <i class="reg_icon_font login_icon_n4 "></i>
                                <input class="inputitemtxt" placeholder="请填写您的手机号码" name="moblie" id="moblie" onblur="check_moblie();" type="tel" onkeyup="this.value=this.value.replace(/[^0-9]/g,'')">
                                <span class="reg_yes" style="display: none;" id="moblie_yes"></span>
                            </div>
                        </dd>
                        <dd>
...
/authcode.inc.php" onclick="checkCode('vcode_img');" />
                        ...
                        <?php }?> <?php if ($_smarty_tpl->tpl_vars['config']->value['reg_useremail']=='1') {?>
                        <dd>
                        ...
                        <?php }?> <?php } elseif ($_smarty_tpl->tpl_vars['type']->value==1) {?>
                        <dd>
                            <div class="c ico_name inputitem_w">
                        ...
                        <dd>
                            <div class="c ico_pwd2 inputitem_w">
                                <i class="reg_icon_font login_icon_n2 "></i>
                                <input class="inputitemtxt" type="password" placeholder="请填写密码，建议填写6-20位字母数字组合" name="password" id="password" type="text" onblur="check_password();">
                                <span class="reg_yes" style="display: none;" id="password_yes"></span>
                                <em class="viewpwd"></em></div>
                        </dd>
