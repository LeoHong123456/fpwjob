<?php /* Smarty version Smarty-3.1.21-dev, created on 2019-11-02 16:54:51
         compiled from "/www/fpwjob/uploads/app/template/admin/admin_email_tpl.htm" */ ?>
<?php /*%%SmartyHeaderCode:1472399705dbd445b330818-62182614%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4952ecf273512dedbc4cd7b3610423ae0e9f9c1f' => 
    array (
      0 => '/www/fpwjob/uploads/app/template/admin/admin_email_tpl.htm',
      1 => 1572067312,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1472399705dbd445b330818-62182614',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5dbd445b45c148_54934874',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5dbd445b45c148_54934874')) {function content_5dbd445b45c148_54934874($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<html>
<head>
...
"> 
    ...
    <tr class="admin_table_trbg">
     ...
     <tr class="admin_table_trbg">
		...
		<tr>
			<th width="160" bgcolor="#f0f6fb" colspan="2"><span class="admin_bold">猎头邮件设置</span></th>
		</tr>
		<tr>
            <th width="160">猎头未登录：</th>
            <td>
            <div class="layui-form-item">
              <div class="layui-input-block">
                 <div class="layui-input-inline">
                   <input type="radio" name="sy_email_ltwdl" value="1" id="sy_email_ltwdl_1" <?php if ($_smarty_tpl->tpl_vars['config']->value['sy_email_ltwdl']=="1") {?>checked<?php }?> title="通知">
                   <input type="radio" name="sy_email_ltwdl" value="2" id="sy_email_ltwdl_2" <?php if ($_smarty_tpl->tpl_vars['config']->value['sy_email_ltwdl']=="2") {?>checked<?php }?> title="不通知">
                 </div>
                 <div class="layui-form-mid layui-word-aux"><a href="?m=emailconfig&c=settpl&name=emailltwdl" style="color:blue;">设置模板</a> </div>
               </div>
            </div>
             </td>
        </tr>
		<tr>
			<th width="160" bgcolor="#f0f6fb" colspan="2"><span class="admin_bold">培训邮件设置</span></th>
		</tr>
        <tr>
            <th width="160">课程审核通过：</th>
            <td>
            <div class="layui-form-item">
              <div class="layui-input-block">
                 <div class="layui-input-inline">
                   <input type="radio" name="sy_email_subjectshtg" value="1" id="sy_email_subjectshtg_0" <?php if ($_smarty_tpl->tpl_vars['config']->value['sy_email_subjectshtg']=="1") {?>checked<?php }?> title="通知">
                   <input type="radio" name="sy_email_subjectshtg" value="2" id="sy_email_subjectshtg_1" <?php if ($_smarty_tpl->tpl_vars['config']->value['sy_email_subjectshtg']=="2") {?>checked<?php }?> title="不通知">
                 </div>
                 <div class="layui-form-mid layui-word-aux"><a href="?m=emailconfig&c=settpl&name=emailsubjectshtg" style="color:blue;">设置模板</a> </div>
               </div>
            </div>
             </td>
        </tr>
        <tr class="admin_table_trbg">
            <th width="160">课程审核未通过：</th>
            <td>
            <div class="layui-form-item">
              <div class="layui-input-block">
                 <div class="layui-input-inline">
                   <input type="radio" name="sy_email_subjectshwtg" value="1" id="sy_email_subjectshwtg_0" <?php if ($_smarty_tpl->tpl_vars['config']->value['sy_email_subjectshwtg']=="1") {?>checked<?php }?> title="通知">
                   <input type="radio" name="sy_email_subjectshwtg" value="2" id="sy_email_subjectshwtg_1" <?php if ($_smarty_tpl->tpl_vars['config']->value['sy_email_subjectshwtg']=="2") {?>checked<?php }?> title="不通知">
                 </div>
                 <div class="layui-form-mid layui-word-aux"><a href="?m=emailconfig&c=settpl&name=emailsubjectshwtg" style="color:blue;">设置模板</a> </div>
               </div>
            </div>
             </td>
        </tr>
