<?php /* Smarty version Smarty-3.1.21-dev, created on 2020-01-29 15:38:09
         compiled from "/www/fpwjob/uploads/app/template/default/hr/index.htm" */ ?>
<?php /*%%SmartyHeaderCode:6883120215e313661ee7f53-89527827%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '29b6102b342de7ab93b6ccfb5b01531dad4bd712' => 
    array (
      0 => '/www/fpwjob/uploads/app/template/default/hr/index.htm',
      1 => 1572067312,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '6883120215e313661ee7f53-89527827',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5e313662002cd7_55643949',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5e313662002cd7_55643949')) {function content_5e313662002cd7_55643949($_smarty_tpl) {?><?php if (!is_callable('smarty_function_url')) include '/www/fpwjob/uploads/app/include/libs/plugins/function.url.php';
...
global $db,$db_config,$config;eval('$paramer=array("item"=>"\'list\'","limit"=>"20","ispage"=>"1","nocache"=>"")
;');$list=array();
		//处理传入参数，并且构造分页参数
		...
		$list=$db->select_all("toolbox_class",$where.$limit);$list = $list; if (!is_array($list) && !is_object($list)) { settype($list, 'array');}
