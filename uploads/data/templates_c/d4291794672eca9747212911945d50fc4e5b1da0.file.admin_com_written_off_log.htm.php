<?php /* Smarty version Smarty-3.1.21-dev, created on 2020-02-16 16:26:31
         compiled from "/www/fpwjob/uploads/app/template/admin/admin_com_written_off_log.htm" */ ?>
<?php /*%%SmartyHeaderCode:11160467595e48fcb7ea8098-87519667%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd4291794672eca9747212911945d50fc4e5b1da0' => 
    array (
      0 => '/www/fpwjob/uploads/app/template/admin/admin_com_written_off_log.htm',
      1 => 1572067312,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '11160467595e48fcb7ea8098-87519667',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5e48fcb8022c59_09258618',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5e48fcb8022c59_09258618')) {function content_5e48fcb8022c59_09258618($_smarty_tpl) {?><?php if (!is_callable('smarty_function_searchurl')) include '/www/fpwjob/uploads/app/include/libs/plugins/function.searchurl.php';
        ...
        <div class="infoboxp">
            <div class="tabs_info">
                <ul>
                    ...
                    <li <?php if ($_GET['c']=='writtenOffLog') {?>class="curr" <?php }?>>
                        <a href="index.php?m=admin_company&c=writtenOffLog">解绑记录</a>
                    </li>
					<li <?php if ($_GET['c']=='member_log') {?>class="curr" <?php }?>>
            ...
            <div class="admin_new_tip">
                ...
                <div class="admin_new_tip_list_cont">
                    <div class="admin_new_tip_list">该页面展示了网站所有的企业账号解除绑定信息。</div>
            ...
            <div class="table-list">
                <div class="admin_table_border">
                    ...
                    <form action="index.php" name="myform" method="get" target="supportiframe" id='myform'>
                        <input name="m" value="admin_company" type="hidden" />
                        <input name="c" value="delwflog" type="hidden" />
                        <table width="100%">
                            <thead>
                                <tr class="admin_table_top">
                                    ...
                                    <th>
                                        <a href="<?php echo smarty_function_searchurl(array('order'=>'desc','t'=>'id','m'=>'admin_company','c'=>'writtenOffLog','untype'=>'order,t'),$_smarty_tpl);?>
">编号<img src="images/sanj.jpg" /></a>
                                    </th>
                                    <?php } else { ?>
                                    <th>
                                        <a href="<?php echo smarty_function_searchurl(array('order'=>'asc','t'=>'id','m'=>'admin_company','c'=>'writtenOffLog','untype'=>'order,t'),$_smarty_tpl);?>
">编号<img src="images/sanj2.jpg" /></a>
                                    ...
                                    <th>
                                        <a href="<?php echo smarty_function_searchurl(array('order'=>'desc','t'=>'ctime','m'=>'admin_company','c'=>'writtenOffLog','untype'=>'order,t'),$_smarty_tpl);?>
">时间<img src="images/sanj.jpg" /></a>
                                    </th>
                                    <?php } else { ?>
                                    <th>
                                        <a href="<?php echo smarty_function_searchurl(array('order'=>'asc','t'=>'ctime','m'=>'admin_company','c'=>'writtenOffLog','untype'=>'order,t'),$_smarty_tpl);?>
...
" name='del[]' onclick='unselectall()' rel="del_chk" /></td>
                                    ...
                                    <td>
                                        <a href="javascript:void(0)" onClick="layer_del('确定要删除？', 'index.php?m=admin_company&c=delwflog&del=<?php echo $_smarty_tpl->tpl_vars['v']->value['id'];?>
');" class="admin_new_c_bth admin_new_c_bth_sc">删除</a>
                                ...
                                <tr>
                                    ...
                                    <td colspan="8">
                                        ...
                                        <input class="admin_button" type="button" value="一键删除" onClick="layer_del('确定要清空企业解绑日志？', 'index.php?m=admin_company&c=delwflog&del=allcom');" /></td>
                                 </tr>
