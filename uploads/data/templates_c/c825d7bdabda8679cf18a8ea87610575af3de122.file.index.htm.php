<?php /* Smarty version Smarty-3.1.21-dev, created on 2020-01-29 07:15:59
         compiled from "/www/fpwjob/uploads/app/template/lietou/index.htm" */ ?>
<?php /*%%SmartyHeaderCode:17873415975e30c0af698587-73650606%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c825d7bdabda8679cf18a8ea87610575af3de122' => 
    array (
      0 => '/www/fpwjob/uploads/app/template/lietou/index.htm',
      1 => 1572067313,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '17873415975e30c0af698587-73650606',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5e30c0af786c20_35391569',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5e30c0af786c20_35391569')) {function content_5e30c0af786c20_35391569($_smarty_tpl) {?><?php if (!is_callable('smarty_function_url')) include '/www/fpwjob/uploads/app/include/libs/plugins/function.url.php';
...
global $config;eval('$paramer=array("limit"=>"9","tuijian"=>"1","type"=>"7","item"=>"\'keylist\'","nocache"=>"")
;');$list=array();
...
<div class="lt_w1200">
<div class="lt_index_tit"><span class="lt_index_tit_s"> 悬赏招聘</span><div class="lt_index_tit_p">
<span class="lt_index_tit_span"><i class="lt_index_tit_linel"></i><i class="lt_index_tit_liner"></i>新鲜职位火速推荐，获得相应赏金</span></div></div>
...
" target="_blank"><?php echo $_smarty_tpl->tpl_vars['jlist']->value['job_name'];?>
</a></div>
<div class="lt_index_rewardjob_comname"><?php echo $_smarty_tpl->tpl_vars['jlist']->value['com_name'];?>
</div>
<span class="lt_index_job_xz"><?php echo $_smarty_tpl->tpl_vars['jlist']->value['salary_info'];?>
</span><span class="lt_index_job_line">|</span><?php echo $_smarty_tpl->tpl_vars['jlist']->value['edu_info'];?>
学历<span class="lt_index_job_line">|</span><?php echo $_smarty_tpl->tpl_vars['jlist']->value['exp_info'];?>
经验<span class="lt_index_job_line">|</span><?php echo $_smarty_tpl->tpl_vars['jlist']->value['cityid_info'];?>
...
</div><div class="lt_index_job_more">	<a href="<?php echo smarty_function_url(array('m'=>'lietou','c'=>'post','rebates'=>1),$_smarty_tpl);?>
...
<?php }?>
<div class="clear"></div>
<div class="lt_index_tit" ><span class="lt_index_tit_s" > 推荐职位</span><div class="lt_index_tit_p"><span class="lt_index_tit_span"><i class="lt_index_tit_linel"></i><i class="lt_index_tit_liner"></i>精选职位任您挑选，快速解决就业难题</span></div></div>
...
global $db,$db_config,$config;eval('$paramer=array("rec"=>"1","order"=>"\'lastupdate\'","ispage"=>"1","limit"=>"8","item"=>"\'tlist\'","nocache"=>"")
;');$tlist=array();
        include_once  PLUS_PATH."/ltjob.cache.php";
		include_once  PLUS_PATH."/lthy.cache.php";
		//处理传入参数，并且构造分页参数
...
</a></div><i class="hotjob_nameicon"></i></div>
...
学历</div>
<!--<div class="hotjob_tag">       
        <?php if ($_smarty_tpl->tpl_vars['tlist']->value['welfarename']) {?>
       <div class="post_items_tag_box"> 
        <?php  $_smarty_tpl->tpl_vars['v'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['v']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['tlist']->value['welfarename']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['v']->key => $_smarty_tpl->tpl_vars['v']->value) {
$_smarty_tpl->tpl_vars['v']->_loop = true;
?>
            <?php if ($_smarty_tpl->tpl_vars['v']->value) {?><span class="hotjob_fl"> <?php echo $_smarty_tpl->tpl_vars['v']->value;?>
</span>    </span><?php }?>
            <?php } ?></div>
       <?php }?>
...
</div></div><div class="lt_w1200">
<div class="clear"></div>
<div class="lt_index_tit"><span class="lt_index_tit_s"> 最新职位</span><div class="lt_index_tit_p"><span class="lt_index_tit_span"><i class="lt_index_tit_linel"></i><i class="lt_index_tit_liner"></i>每日精选优质职位，满足你的个性要求</span></div></div>
<div class="lt_index_job_box">
<div class="lt_index_job_c">
...
global $db,$db_config,$config;eval('$paramer=array("comlen"=>"10","item"=>"\'ltjoblist\'","ispage"=>"1","limit"=>"16","nocache"=>"")
;');$ltjoblist=array();
        include_once  PLUS_PATH."/ltjob.cache.php";
		include_once  PLUS_PATH."/lthy.cache.php";
		//处理传入参数，并且构造分页参数
...
?>
<li><i class="lt_index_job_box_ulline"></i>
...
</a></div><div class="lt_index_job_yq"><?php echo $_smarty_tpl->tpl_vars['ltjoblist']->value['edu_info'];?>
<span class="lt_index_job_line"><?php if ($_smarty_tpl->tpl_vars['ltjoblist']->value['edu_info']) {?>|<?php }?></span><span class="lt_index_job_xz"><?php echo $_smarty_tpl->tpl_vars['ltjoblist']->value['salary_info'];?>
</span></div>
...
<div class="lt_index_tit"><span class="lt_index_tit_s"> 委托求职</span><div class="lt_index_tit_p"><span class="lt_index_tit_span"><i class="lt_index_tit_linel"></i><i class="lt_index_tit_liner"></i>找工作不随便，这里是野心与实力的汇聚</span></div></div>
<div class="lt_index_job_box">
<div class="lt_index_job_c">

<ul class="lt_index_h">
				<?php  $_smarty_tpl->tpl_vars['ltlist'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['ltlist']->_loop = false;
global $db,$db_config,$config;eval('$paramer=array("ispage"=>"1","limit"=>"8","item"=>"\'ltlist\'","nocache"=>"")
;');$ltlist=array();
...
?>
                <li>
<div class="lt_photo"><img src="<?php echo smarty_function_formatpicurl(array('path'=>$_smarty_tpl->tpl_vars['ltlist']->value['photo_big'],'type'=>'ltlogo'),$_smarty_tpl);?>
" width="70" height="70">                                    <a href="javascript:ltatn('<?php echo $_smarty_tpl->tpl_vars['ltlist']->value['uid'];?>
');" id="guanzhu<?php echo $_smarty_tpl->tpl_vars['ltlist']->value['uid'];?>
...
<div class="lt_index_p_wt_bot"><a href="<?php echo $_smarty_tpl->tpl_vars['ltlist']->value['name_url'];?>
...
" target="_blank"><img class="png" src="<?php echo smarty_function_formatpicurl(array('path'=>$_smarty_tpl->tpl_vars['linklist']->value['pic']),$_smarty_tpl);?>
