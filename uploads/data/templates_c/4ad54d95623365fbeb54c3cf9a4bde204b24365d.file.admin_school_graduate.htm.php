<?php /* Smarty version Smarty-3.1.21-dev, created on 2019-11-08 15:47:07
         compiled from "/www/fpwjob/uploads/app/template/admin/admin_school_graduate.htm" */ ?>
<?php /*%%SmartyHeaderCode:15815368185dc51d7b1958b6-33418588%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4ad54d95623365fbeb54c3cf9a4bde204b24365d' => 
    array (
      0 => '/www/fpwjob/uploads/app/template/admin/admin_school_graduate.htm',
      1 => 1572067312,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '15815368185dc51d7b1958b6-33418588',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5dc51d7b25ed76_66050733',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5dc51d7b25ed76_66050733')) {function content_5dc51d7b25ed76_66050733($_smarty_tpl) {?><?php if (!is_callable('smarty_function_searchurl')) include '/www/fpwjob/uploads/app/include/libs/plugins/function.searchurl.php';
...
<a href="javascript:;" class="admin_new_tip_open" style="display:none;"></a>
    ...
    <div class="admin_new_tip_list_cont">
      <div class="admin_new_tip_list">该页面展示了网站接受应届生的企业职位信息，可对职位进行编辑修改操作。</div>
  ...
  <div class="admin_new_search_box">
    <form action="index.php" name="myform" method="get" >
      <input type="hidden" name="m" value="admin_school_graduate"/>
...
" name='type'>
  ...
  <div class="clear"></div>
	...
	<div class="admin_statistics">
		总数：<span class="ajaxjoball">0</span>；
		未审核：<span class="ajaxjobstatus1">0</span>；
		未通过：<span class="ajaxjobstatus2">0</span>；
		已下架：<span class="ajaxjobstatus3">0</span>；
...
" class="check_all" name="del[]" onclick="unselectall()" rel="del_chk" style="margin-left:5px;"></td>
            <td class="td1" style="text-align:center;width:50px;"><span><?php echo $_smarty_tpl->tpl_vars['v']->value['id'];?>
</span></td>
            <td class="ud" align="left" width="210"><div class="admin_jobname"> <a href="<?php echo smarty_function_url(array('m'=>'job','c'=>'comapply','id'=>$_smarty_tpl->tpl_vars['v']->value['id'],'look'=>'admin'),$_smarty_tpl);?>
" target="_blank"><?php echo $_smarty_tpl->tpl_vars['v']->value['name'];?>
</a></div>
              <div class="admin_job_comname"><a href="<?php echo smarty_function_url(array('m'=>'company','c'=>'show','id'=>$_smarty_tpl->tpl_vars['v']->value['uid']),$_smarty_tpl);?>
...
"> <?php if ($_smarty_tpl->tpl_vars['v']->value['status']==1) {?> <span class="admin_com_Lock" onclick="checkstate('<?php echo $_smarty_tpl->tpl_vars['v']->value['id'];?>
...
' class="admin_new_c_bth admin_new_c_bthsh status" >审核</a>  <a href="index.php?m=admin_company_job&c=matching&id=<?php echo $_smarty_tpl->tpl_vars['v']->value['id'];?>
...
$(document).ready(function(){
	...
	$.get("index.php?m=admin_school_graduate&c=sjobNum", function(data) {
		var datas = eval('(' + data + ')');
		if(datas.jobAllNum) {
