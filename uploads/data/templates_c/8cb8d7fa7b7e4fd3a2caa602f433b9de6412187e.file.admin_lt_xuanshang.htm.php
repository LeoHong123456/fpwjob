<?php /* Smarty version Smarty-3.1.21-dev, created on 2019-11-09 09:05:25
         compiled from "/www/fpwjob/uploads/app/template/admin/admin_lt_xuanshang.htm" */ ?>
<?php /*%%SmartyHeaderCode:6911800505dc610d58195c3-79030601%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8cb8d7fa7b7e4fd3a2caa602f433b9de6412187e' => 
    array (
      0 => '/www/fpwjob/uploads/app/template/admin/admin_lt_xuanshang.htm',
      1 => 1572067312,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '6911800505dc610d58195c3-79030601',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5dc610d5885976_96601547',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5dc610d5885976_96601547')) {function content_5dc610d5885976_96601547($_smarty_tpl) {?><?php if (!is_callable('smarty_function_searchurl')) include '/www/fpwjob/uploads/app/include/libs/plugins/function.searchurl.php';
...
<div class="admin_new_tip_list">该页面展示了网站所有的猎头悬赏管理信息，可对猎头悬赏进行审核删除操作。</div>
...
"/>
    ...
    <div class="admin_Filter_text formselect"  did='dtype'>
        <input type="button" value="<?php if ($_GET['type']=='1'||$_GET['type']=='') {?>推荐人<?php } elseif ($_GET['type']=='4') {?>接收人<?php }?>" class="admin_Filter_but"  id="btype">
...
">编号 <img src="images/sanj.jpg"/></a> <?php } else { ?> <a href="<?php echo smarty_function_searchurl(array('order'=>'asc','t'=>'id','m'=>'admin_lt_xuanshang','untype'=>'order,t'),$_smarty_tpl);?>
...
">推荐时间 <img src="images/sanj.jpg"/></a> <?php } else { ?> <a href="<?php echo smarty_function_searchurl(array('order'=>'asc','t'=>'datetime','m'=>'admin_lt_xuanshang','untype'=>'order,t'),$_smarty_tpl);?>
">推荐时间 <img src="images/sanj2.jpg"/></a> <?php }?></th>
...
">回复时间 <img src="images/sanj.jpg"/></a> <?php } else { ?> <a href="<?php echo smarty_function_searchurl(array('order'=>'asc','t'=>'reply_time','m'=>'admin_lt_xuanshang','untype'=>'order,t'),$_smarty_tpl);?>
">回复时间 <img src="images/sanj2.jpg"/></a> <?php }?></th>
              <th>状态</th>
...
if ($_smarty_tpl->tpl_vars['config']->value['lt_rebates_name']) {?> <?php echo $_smarty_tpl->tpl_vars['config']->value['lt_rebates_name'];?>
 <?php } else { ?>元<?php }?></td>
            ...
            <td ><?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['v']->value['reply_time'],"%Y-%m-%d");?>
</td>
            <td><?php if ($_smarty_tpl->tpl_vars['v']->value['status']==4) {?><span class="admin_com_fl">已返利</span><?php } elseif ($_smarty_tpl->tpl_vars['v']->value['status']==1) {?><span class="admin_com_Audited">已查看</span><?php } elseif ($_smarty_tpl->tpl_vars['v']->value['status']==2) {?><span class="admin_com_Lock">已试用</span><?php } elseif ($_smarty_tpl->tpl_vars['v']->value['status']==0) {?><span class="admin_com_noAudited">未查看</span><?php } elseif ($_smarty_tpl->tpl_vars['v']->value['status']==3) {?><span class="admin_com_tg">未通过</span><?php }?></td>
            <td>
