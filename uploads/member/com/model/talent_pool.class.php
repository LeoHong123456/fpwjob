	...
	function index_action(){
		...
		if(is_array($rows)){ 
			if(empty($resume)){
				...
				$resume=$this->obj->DB_select_alls("resume","resume_expect","a.uid=b.uid and a.`r_status`<>'2' and a.uid in (".pylode(',',$uid).")","a.`name`,a.`uid`,a.`sex`,a.`edu`,b.`job_classid`,a.`exp`,b.`id`,a.`nametype`,b.`minsalary`,b.`maxsalary`");
